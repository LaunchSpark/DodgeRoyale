...
The web game's AI dashboard link is in `web/index.html`; browser/WASM code does
not spawn Python. `run.sh web` and `web-docker` start marimo from the existing
training virtual environment on loopback port 2718 before starting the web
